...
export default function App() {
  ...
  function handleClick(e) {
    ...
    const unclicked = currentEmojis.filter((e) => e !== emoji)
    const randomEmoji = getRandomEmojis()
    setLikedEmojis((prevLikedEmojis) => [...prevLikedEmojis, emoji]);
    setPassedEmojis((prevPassedEmojis) => [...prevPassedEmojis, ...unclicked])   
    setCurrentEmojis(randomEmoji)
  }
